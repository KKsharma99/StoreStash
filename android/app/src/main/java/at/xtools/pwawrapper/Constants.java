...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://storestash.now.sh/?fbclid=IwAR0PYdq6CgGX5UxkBCtf03-P7_wn59tYuVZzr6CjJ3eaUzlkZtcVNyghgC4";
    public static String WEBAPP_HOST = "storestash.now.sh"; // used for checking Intent-URLs
